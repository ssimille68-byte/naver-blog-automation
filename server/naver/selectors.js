...
export const SEARCH = {
  news: {
    ...
    date: ['span.info', '.sds-comps-profile-info-subtext'],
    // 제목이 잡히는 블록 바깥에 있는 출처·날짜를 찾아 올라갈 때 쓰는 이정표.
    titleMarker: 'a.news_tit, span.sds-comps-text-type-headline1',
    metaMarker: '.sds-comps-profile, .news_info, .info_group',
    maxClimb: 8,
  ...
  blog: {
    ...
    date: ['span.sub', '.sds-comps-profile-info-subtext'],
    titleMarker: 'a.title_link, a.api_txt_lines.total_tit, span.sds-comps-text-type-headline1',
    metaMarker: '.sds-comps-profile, .user_info',
    maxClimb: 8,
